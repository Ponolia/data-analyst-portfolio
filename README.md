...
👉 특히 이탈 고객은
위 지표 중 2개 이상이 동시에 악화되는 경향을 보였습니다.
...
⚠️ Medium Risk	0.4 ≤ 이탈 확률 < 0.7	맞춤형 알림 및 이용 유도
✅ Low Risk	이탈 확률 < 0.4	로열티 강화 및 Cross-selling
📌 기준 설명
모델 학습 단계: Recall 확보를 위해 threshold를 낮춰 실험
운영 단계: 마케팅 자원 효율성과 과도한 타겟팅 방지를 위해
👉 보수적인 기준(0.7 / 0.4) 적용
🎯 기대 효과
고위험 고객 선제 대응
고객 이탈률 감소
...
👉 최종 모델: Weighted XGBoost

### 5️⃣ 실무 적용 방안

모델 예측 결과를 DB에 반영하여
마케팅 및 CRM 시스템에서 실시간 위험 고객 추출 가능하도록 설계

💡 적용 방식
Risk Segmentation 자동 분류
SQL 기반 타겟 고객 추출
CRM 시스템 연동
🎯 기대 효과
고위험 고객 선제 대응
